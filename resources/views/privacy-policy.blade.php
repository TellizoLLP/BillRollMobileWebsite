    ...
    <main class="pt-32 pb-20 lg:pt-40 lg:pb-28">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="prose prose-lg text-gray-600">
                ...
                <p>At BillRoll, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclosure, and safeguard your information when you visit our website or use our mobile application.</p>
                
                <h3>Information We Collect</h3>
                <p>We may collect information about you in a variety of ways. Key information may include:</p>
                <ul>
                    <li><strong>Personal Data:</strong> Name, email address, and billing information.</li>
                    <li><strong>Usage Data:</strong> Information about how you use our app and website.</li>
                </ul>

                <h3>Use of Your Information</h3>
                <p>We use the information we collect to provide, maintain, and improve our services, including processing transactions and sending related information.</p>

                <h3>Contact Us</h3>
                <p>If you have questions or comments about this Privacy Policy, please contact us at support@billroll.com.</p>
            </div>
        </div>
    </main>
